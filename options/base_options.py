...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', required=True, help='path to datasets')
        ...
        self.parser.add_argument('--which_model_netG', type=str, default='MUST', help='selects model to use for netG')
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='./check_points', help='models are saved here')
        self.parser.add_argument('--norm', type=str, default='instance', help='instance normalization or batch normalization')
        self.parser.add_argument('--serial_batches', action='store_true', help='if true, takes images in order to make batches, otherwise takes them randomly')
        self.parser.add_argument('--display_winsize', type=int, default=256,  help='display window size')
        self.parser.add_argument('--display_id', type=int, default=1, help='window id of the web display')
        self.parser.add_argument('--display_port', type=int, default=8090, help='visdom port of the web display')
        ...
        self.parser.add_argument('--BP_input_nc', type=int, default=19, help='# of input image channels')
        ...
        self.parser.add_argument('--pairLst', type=str, help='paired data path')
        self.parser.add_argument('--unpairLst', type=str, help='unpaired data path')
