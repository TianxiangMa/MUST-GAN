...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lambda_style', type=float, default=150.0, help='weight of CX loss')
        ...
        self.parser.add_argument('--use_styleloss', type=int, default=1, help='use cxloss or not')
